        		...
        		<div class="content-1">
                    <div class="row">
                        <div class="col s9">
                            ...
                            <a class="of-learning">of 15</a>
                        </div>
                        <div class="col s3 custom-time">
                            <a class="of-learning"> Waktu Tersisa : </a> 
            		...
            		<div class="row custom-question">
            			...
            			<div class="col s2 custom-button-learning">
            				<button class="btn next-answer-learning-back"> 
                                <i class="fa fa-chevron-left" aria-hidden="true"></i>
                            </button>
            			</div>
            			<div class="col s2 custom-button-learning">
            				<button class="btn next-answer-learning">
                                <a class="back-question-learning"> Selanjutnya </a>
                                <i class="fa fa-chevron-right" aria-hidden="true"></i> 
                            </button>
            			</div>
                        <div class="col s8 custom-missed">
                            <div class="row">
                                <div class="col s12">
